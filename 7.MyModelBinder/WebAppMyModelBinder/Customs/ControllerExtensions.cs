...
namespace WebAppMyModelBinder.Customs
{
    ...
    {
        public static object InvokeAction(this Controller controller, string actionName,IModelBinder modelBinder)
        {
            //IModelBinder modelBinder = new MyDefaultModelBinder1();
